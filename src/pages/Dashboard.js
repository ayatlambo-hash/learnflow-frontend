...
function ChatTab({ user }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "calc(150vh - 190px)", backgroundImage: "url('https://i.pinimg.com/736x/4b/c5/b7/4bc5b782e71a43bd1c49f4d03de36d40.jpg')", backgroundSize: "cover", backgroundPosition: "center", borderRadius: 50}}>
